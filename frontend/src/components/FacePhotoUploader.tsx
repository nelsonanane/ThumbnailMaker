  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-gray-500">
        Upload face photos to replace the characters in your reference thumbnail. All uploaded faces will be used.
      </p>
      ...
      {facePhotos.length > 0 && (
        <p className="text-xs text-gray-500">
          {facePhotos.length === 1
            ? 'This face will replace the character in your reference thumbnail.'
            : `All ${facePhotos.length} faces will replace the characters in your reference thumbnail.`}
        </p>
      )}
    </div>
  );
